    ...
    private class AsyncLogin extends AsyncTask<String,String ,String> {
        ...
        protected String doInBackground(String... params) {
            try{
                ...
                url=new URL("http://120.0.0.1/cppbetterc/loginc.php");
        ...
        protected  void onPostExecute(String result){
             ...
             */
                ...
                Toast.makeText(MainActivity.this,"OOPs! Something went wrong . Connection Problem.exception",Toast.LENGTH_LONG).show();
            }
        }
    }
}